 ...
 */
export declare function numberOfElementsToBeMoreThan(selectorOrElementArray: string | Promise<WebdriverIO.ElementArray>, expectedNumber: number): () => Promise<boolean>;
