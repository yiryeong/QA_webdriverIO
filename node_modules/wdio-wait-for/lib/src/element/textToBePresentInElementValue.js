...
exports.textToBePresentInElementValue = void 0;
 ...
 */
function textToBePresentInElementValue(selectorOrElement, expectedValue) {
    return function () {
        return __awaiter(this, void 0, void 0, function* () {
            const element = yield utils_1.getElement(selectorOrElement);
            const value = yield element.getValue();
            return value.includes(expectedValue);
        });
    };
}
exports.textToBePresentInElementValue = textToBePresentInElementValue;
