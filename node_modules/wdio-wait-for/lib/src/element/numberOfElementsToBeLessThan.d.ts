 ...
 */
export declare function numberOfElementsToBeLessThan(selectorOrElementArray: string | Promise<WebdriverIO.ElementArray>, expectedNumber: number): () => Promise<boolean>;
